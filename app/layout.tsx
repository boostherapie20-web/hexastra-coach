...
export const metadata: Metadata = {
  ...
  metadataBase: new URL(process.env.NEXT_PUBLIC_APP_URL ?? 'https://hexastra.com'),
  openGraph: {
    title: 'HexAstra — Comprenez votre moment de vie',
    description:
      'HexAstra analyse votre situation et vous donne des clés concrètes pour vos relations, vos décisions et votre évolution personnelle.',
    url: '/',
    siteName: 'HexAstra Coach',
    locale: 'fr_FR',
    type: 'website',
  },
  twitter: {
    ...
    title: 'HexAstra — Comprenez votre moment de vie',
    description:
      'Analyse stratégique de votre situation : relations, décisions, évolution personnelle.',
  },
  icons: {
    icon: [
