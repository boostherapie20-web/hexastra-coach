...
import CosmicBackground from './_components/CosmicBackground'
  ...
  const handleSend = useCallback(
    async (provided?: string) => {
      ...
      try {
        ...
        if (content.length < 220) cacheRef.current.set(content, reply)
              ...
              <div style={{ display: 'flex', justifyContent: 'center', marginTop: 18 }}>
                ...
                >
                  ...
                  >
                    ...
                    <div style={{ fontSize: 11, color: DS.textFaint }}>{userEmail || 'Session locale'}</div>
                  </div>
                </div>
              </div>
            )}
