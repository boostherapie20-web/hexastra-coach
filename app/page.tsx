...
// Local type - accepts both FR and EN regardless of as const in i18n.ts
...
function Nav({ t, lang, setLang, onCta }: { t: T; lang: Lang; setLang: (l: Lang) => void; onCta: () => void }) {
  return (
    <nav className="nav">
...
function Hero({ t, lang, onCta }: { t: T; lang: Lang; onCta: () => void }) {
  return (
...
function ExampleSection({ t, onCta }: { t: T; onCta: () => void }) {
  return (
...
function PractitionerSection({ t, onCta }: { t: T; onCta: () => void }) {
  return (
    <section className="section bg-deep">
      <div className="section-inner">
...
function PricingSection({ t, onCta }: { t: T; onCta: (key: string) => void }) {
...
function FinalCta({ t, onCta }: { t: T; onCta: () => void }) {
  return (
